...
| PR Title | PR Number | Status |
|----------|-----------|--------|
| [feat: add option to change launcher button position](https://github.com/civiks/unfold-iitm/pull/10) | [#10](https://github.com/civiks/unfold-iitm/pull/10) | Merged |
| [feat: add drag-and-drop positioning for launcher button](https://github.com/civiks/unfold-iitm/pull/12) | [#12](https://github.com/civiks/unfold-iitm/pull/12) | Open |
